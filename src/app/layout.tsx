  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <meta name="google-site-verification" content="vxMBNqFfHUihXBtPRpWisDdoIkE4Z5YdgbfZjvk2CDU" />
        {/* Google tag (gtag.js) */}
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=G-GSK9BYDZXS"
          strategy="afterInteractive"
        />
        <Script id="gtag-init" strategy="afterInteractive">
          {`window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'G-GSK9BYDZXS');`}
        </Script>
      </head>
